...
/>
  ...
  <aside
    ...
    className={[
      /*
       * Mobile:
       * fixed drawer from the right.
       *
       * Desktop:
       * normal flex item with fixed width.
       * This prevents the sidebar from overlapping
       * or appearing over the page content.
       */
...
return ( <div className="mb-6"> <p className="mb-2 px-3 text-[10px] font-bold tracking-wide text-slate-400">
{title} </p>
